    ...
    componet() {
        this.name = class extends HTMLElement {
            ...
            async drawtable() {
                ...
                let response_city = await fetch("http://localhost/SkylAb-152/pruebacampus/departamento", {
                    method: "GET",
                    headers: headersList
                });
            ...
            async region(id){
                ...
                let response_areas = await fetch(`http://localhost/SkylAb-152/pruebacampus/region/${id}`, {
                    method: "GET",
                    headers: headersList
                });
